...
const Claude = {
 ...
 getNutrition: (name) => Groq.callJSON([{ role: "user", content: `Give accurate nutritional information for "${name}". Calculate based on the quantity mentioned. If this is not a food item, return null. Return ONLY valid JSON: {"calories":0,"protein":"0g","carbs":"0g","fat":"0g","fiber":"0g","dietType":""}` }]),
};
  ...
  return <div style={{ minHeight: "100vh", background: C.bg, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: 24 }}>
    <div style={{ width: "100%", maxWidth: 360 }}>
      ...
      {mode === "landing" && <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
       ...
       <p style={{ color: C.muted, marginTop: 8, fontSize: 14 }}>Turn Ingredients Into Delicious Meals. 🍳✨</p>
<p style={{ color: C.muted, marginTop: 4, fontSize: 12 }}>Cook Smarter. Waste Less.</p> 
      </div>}
